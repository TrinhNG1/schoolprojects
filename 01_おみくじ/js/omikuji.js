...
btn1.addEventListener('click',
    ...
    let resultMaxSpeed;
    resultMaxSpeed = ["0","10","8","5","5","5"];
    let resultMaxSize;
    resultMaxSize = ["30","30","20","15","20","20"];
    let resultImage;
    resultImage = ["img/star.png","img/sakura_hanabira.png","img/sakura_hanabira.png","img/sakura_hanabira.png","img/leaf.png","img/snowflakes.png"];
